...
return [
    ...
    'low_stock' => [
        'heading'       => "Extra's met lage voorraad",
        'description'   => "Extra's met nog 3 of minder stuks",
        'empty_heading' => "Alle extra's zijn goed voorradig",
    ],

    'monthly_revenue' => [
        'heading' => 'Maandomzet (laatste 6 maanden)',
        'dataset' => 'Omzet (€)',
    ],
    ...
    'reservations_by_status' => [
        'heading' => 'Reserveringen per status',
    ],
